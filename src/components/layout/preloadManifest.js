...
export const MANIFEST = [
  ...
  { kind: 'image', url: POSTER_URL, bytes: 234872, label: 'Stills' },
  { kind: 'image', url: '/assets/hero-threshold.jpg', bytes: 66926, label: 'Stills' },
  { kind: 'image', url: '/assets/hero-ending.jpg', bytes: 57115, label: 'Stills' },
